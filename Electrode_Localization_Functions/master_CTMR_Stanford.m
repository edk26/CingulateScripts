...
[out_els,out_els_ind]=electrodes2surf('name',4,1,[71:80],'./data/electrodes_loc1.mat',surface_name,t1_name);
% aST 1xN strip (project to closest point on the surface, no direction):
[out_els,out_els_ind]=electrodes2surf('name',0,2,[65:70],'./data/electrodes_loc1.mat',surface_name,t1_name);
